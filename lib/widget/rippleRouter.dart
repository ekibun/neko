/// 作者：梦魇兽
/// 链接：https://juejin.cn/post/6844904057660784654
/// 来源：掘金
...
class RippleRoute extends PageRouteBuilder {
  ...
  final void Function() onAnimateFinished;

  RippleRoute(this.widget, this.routeConfig, {this.onAnimateFinished})
      : super(
          // 设置过度时间
          ...
          transitionsBuilder: (
            ...
            if ((animation as ProxyAnimation).parent is AnimationController && animation.isCompleted) {
              onAnimateFinished?.call();
              return child;
            }
            return Stack(
